      ...
      <form name="postForm" action="drmx_login.php" method="post">
         <div class="login-cont">
            ...
            <div class="login-foot">
               <div class="foot-acts">
                  Por favor, acceda a su cuenta y obtenga una licencia. Si no compra un curso, visite nuestro sitio web. <a href="<?php echo site_url() ?>" target="_blank"><?php echo site_url() ?></a>
               </div>
            </div>
         </div>
	   </form>
